...
# install packages pyttsx3,requests,wikipedia,pywhatkit,SpeechRecognition,PyAudio
...
if __name__ == "__main__":
    ...
    if 'open notepad' in query:
        ...
        try:
            ...
            speak("Sorry, there was an error playing music.")
            print(f"Error: {e}")
    ...
    #         speak("No matching page found. Please try again.")
